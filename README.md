...
## Project Structure
    ...
    ├── dev_churn_handling_1  # Django project configurations
...
1. Clone this repo and `cd dev_churn_handling_1`
...
2. Clone this repo and `cd dev_churn_handling_1`
